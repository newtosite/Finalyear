...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
    <head>
        <title>TOUR MODE PROTOTYPE</title>
        <meta name="viewport" content="initial-scale=1.0, user-scalable=no">
                <meta http-equiv="Content-Type"content="text/html; charset=utf-8"/>
                <script type="text/javascript" src="js/jquery.min.js"></script>
                <script src="https://apis.mapmyindia.com/advancedmaps/v1/rje4z26h977frnpuf4h7spuu8delh4fl/map_load?v=0.1"></script>
				<script src=""></script>
					<style type="text/css">
                    /*map css **/
                    body,html {
                ...
                <body>
                    <div class="top-div">
                        <span class="top-div-span1">TOUR MODE PROTOTYPE</span> 
                        <span class="top-div-span2" >Nearby</span>
                    </div>
                    <div id="menu">
                        <div class="menu-sub"> 
                            <div class="div-label">Latitude</div>
                            ...
                            <div class="div-label">Longitude</div>
                            ...
                            <input type="hidden" class="input-cls" id="keyword" placeholder="keyword" autocomplete="off" autofocus="" value="" onkeydown="if (event.which == 13 || event.keyCode == 13)
                                               $('#search').trigger('click'); " multiple/>
                            <br/><br/>
                            &nbsp;&nbsp;
                        ...
                        function get_near_by_result(lat, lng, searchmethod) {
                            ...
                            document.getElementById('result').innerHTML = '<div style="padding: 0 12px; color: #777">Loading..</div>';
                                ...
                                if(lat=='' || lng=='')
                                {
                                    ...
                                    getUrlResult(map_center.lat, map_center.lng);
                                }
                                else
                                {
                                    getUrlResult(lat, lng);   
                                }
                        }
